            ...
            <li  key='dropMeals' className="nav-item dropdown">
                <> 
                    ...
                    <div className="btn-group">
                        <button className="nav-link btn-lg" type="button">
                          <h1>Meals</h1>
                        </button>
            ...
            <li  key='dropDrinks' className="nav-item dropdown">
                <> 
                    <i className="App-logo">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-cup-straw App-logo" viewBox="0 0 16 16">
                    ...
                    <div className="btn-group">
                        <button className="nav-link btn-lg">
                        <h1>Drinks</h1>
                        </button>
                        <button  className="nav-link dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                            <span className="visually-hidden">Toggle Dropdown</span>
