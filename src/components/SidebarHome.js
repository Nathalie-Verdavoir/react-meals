...
const SidebarHome = ({openedSidebarDrink}) => {

    const mealShow = openedSidebarDrink ? "" : " show"
    const drinkShow = openedSidebarDrink ? " show" : ""
            ...
            <section className="col-12 col-lg-2 sidebar-home">
                    <div className="accordion" id="accordion">
                        ...
                        <div className="accordion-item">
                            ...
                            <button className="accordion-button drink" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded={!openedSidebarDrink} aria-controls="collapseTwo">
                                <i  className="fas">
